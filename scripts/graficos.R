...
ggplot(dados[!is.na(`CAM D`)], aes(`CAM D`)) + geom_bar(aes(fill = SEXO), position = "dodge")
ggplot(dados[!is.na(`CAM E`)], aes(`CAM E`)) + geom_bar(aes(fill = SEXO), position = "dodge")
ggplot(dados[!is.na(`PINCER D`)], aes(`PINCER D`)) + geom_bar(aes(fill = SEXO), position = "dodge")
ggplot(dados[!is.na(`PINCER E`)], aes(`PINCER E`)) + geom_bar(aes(fill = SEXO), position = "dodge")
ggplot(dados[!is.na(`MISTO D`)], aes(`MISTO D`)) + geom_bar(aes(fill = SEXO), position = "dodge")
ggplot(dados[!is.na(`MISTO E`)], aes(`MISTO E`)) + geom_bar(aes(fill = SEXO), position = "dodge")

ggplot(dados[!is.na(CAM)], aes(CAM)) + geom_bar(aes(fill = SEXO), position = "dodge") + scale_y_continuous(limits = c(0,nrow(dados)))
ggsave("figures/CAM.png")
ggplot(dados[!is.na(PINCER)], aes(PINCER)) + geom_bar(aes(fill = SEXO), position = "dodge") + scale_y_continuous(limits = c(0,nrow(dados)))
ggsave("figures/PINCER.png")
ggplot(dados[!is.na(MISTO)], aes(MISTO)) + geom_bar(aes(fill = SEXO), position = "dodge") + scale_y_continuous(limits = c(0,nrow(dados)))
