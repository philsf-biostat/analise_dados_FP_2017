...
CAM (p = `r pv(ft.sexo.cam)`)

PINCER (p = `r pv(ft.sexo.pincer)`)

MISTO (p = `r pv(ft.sexo.misto)`)
...
CAM (p = `r pv(ft.grupo.cam)`)

PINCER (p = `r pv(ft.grupo.pincer)`)

MISTO (p = `r pv(ft.grupo.misto)`)
