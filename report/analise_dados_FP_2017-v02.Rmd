...
Nossa amostra também indica que impacto do tipo Pincer é `r format.pct(-as.numeric(fisher.OR(ft.sexo.pincer, 2)), 0, pct.symbol = TRUE)`  menos frequente em homens que em mulheres (p = `r pv(ft.sexo.pincer)`).
