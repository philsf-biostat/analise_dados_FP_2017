...
(p = `r pv(ft.sexo.imp)`)
.
Avaliamos a diferença entre as prevalências dos impactos do tipo CAM e Pincer em cada um dos gêneros (Figura 39).
Tomando o gênero feminino como referência, demostramos os resultados relativos para os homens, expressos em razão de chance.
...
(RC: `r log.sexo.imp.res[3, 1]`, IC: `r log.sexo.imp.res[3, 2]`)
, nem impacto do tipo Misto
(RC: `r log.sexo.imp.res[2, 1]`, IC: `r log.sexo.imp.res[2, 2]`)
.

Analisamos também a relação da dor com cada tipo de impacto (Figura 39).
Não há evidências de que os impactos ocorreram de forma diferenciada por grupo
(p = `r pv(ft.grupo.imp)`)
.

<!-- Observamos que a presença de CAM foi -->
<!-- `r log.grupo.imp.res[1, 1]` -->
<!-- vezes mais frequente nos quadris dolorosos -->
<!-- (RC: `r log.grupo.imp.res[1, 1]`, IC: `r log.grupo.imp.res[1, 2]`) -->
<!-- que no grupo controle. -->
<!-- Não houve diferença significativa nas ocorrências para Pincer -->
<!-- (RC: `r log.grupo.imp.res[3, 1]`, IC: `r log.grupo.imp.res[3, 2]`) -->
<!-- e Misto -->
