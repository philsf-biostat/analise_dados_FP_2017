...
Table: **Tabela 4** Regressão logística entre os tipos de impacto e o gênero.

Analisamos também a relação da dor com cada tipo de impacto (Tabela 5).
...
Table: **Tabela 5** Regressão logística entre os tipos de impacto e o grupo.
